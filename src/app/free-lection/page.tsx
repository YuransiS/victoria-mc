...
export default function FreeLectionPage() {
    ...
    useEffect(() => {
        ...
        const uavslabParam = params.get('uavslab');
        if (uavslabParam) {
            localStorage.setItem('uavslab', uavslabParam);
        }
    ...
    const onSubmit = async (data: FormData) => {
        ...
        const params = new URLSearchParams(window.location.search);
        const uavslabVal = params.get('uavslab') || localStorage.getItem('uavslab') || '';
