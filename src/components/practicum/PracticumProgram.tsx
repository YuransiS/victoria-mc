  ...
  const days = [
    {
      ...
      desc: "Не банально розповідаємо про свій день, розкриваючи себе, а не просто по фактам. Вчимося викликати інтерес до свого способу життя.",
    },
    {
      day: "2 день",
      title: "Зв'язок через звички",
      desc: "Розкриваємо особистість через призму наших звичок, мислення та цінностей. Будуємо глибший зв'язок з аудиторією.",
